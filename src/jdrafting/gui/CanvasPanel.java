...
public class CanvasPanel extends JPanel
{
	...
	private double borderPrecision = 8.;  // min precision to select shapes
	...
	public List<JDraftingShape> getAllShapesAtCanvasPoint(
	...
	public JDraftingShape getShapeAtCanvasPoint( Point2D mousePosition )
	{
		double x = mousePosition.getX(), y = mousePosition.getY();
	 ...
	 * @param mousePosition canvas position
	 * @return the position of the point or the logic mouse position
	 */
	public Point2D adjustToPoint( Point2D mousePosition )
	{
		// check for shapes at mouse position
		JDraftingShape jdshape = getShapeAtCanvasPoint( mousePosition ); 
		if ( jdshape != null )
		{
		...
		return getInverseTransform().transform( mousePosition, null ); 
	}
